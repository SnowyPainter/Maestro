...
CARD_TYPE_BY_MODEL_NAME: Mapping[str, str] = {
    ...
    "DashboardOverviewResponse": "playbook.dashboard.overview",
    "DashboardEventChainResponse": "playbook.dashboard.event_chain",
    "DashboardPerformanceResponse": "playbook.dashboard.performance",
    "DashboardInsightsResponse": "playbook.dashboard.insights",
    "DashboardRecommendationsResponse": "playbook.dashboard.recommendations",
    "MessageOut": "info",
